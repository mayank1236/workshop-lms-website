            ...
            <Container>
                ...
                <div className={pricing.pricing} onClick={handleClick}>
                    <div className={pricing.price}>
                        ...
                        <ul>
                            <li>Learn from 10 top instructors joining us for the workshop. They will guide you through diverse methods & techniques to help you take your mandala-making skills to the next level.</li>
