...
const Instructor = () => {
    ...
    const instructors = [
        {
            url: 'instructors/Chetna Singla (@mandalasbychetna).jpg',
            name: 'Chetna Singla',
        ...
        {
            url: 'instructors/Leepi Dedhia (@handmadebyleepidedhia).jpeg',
            name: 'Leepi Dedhia',
        ...
        {
            url: 'instructors/Fernanda Bonafini (@ataraxiaowl).png',
            name: 'Fernanda',
            handle: '@ataraxiaowl',
        ...
        {
            url: 'instructors/Vaishnavi Luniya (@mandalabyvaishnavi).jpg',
        ...
        {
            url: 'instructors/Divdrisht Suri (@mandalas_by_divdrisht).jpeg',
            name: 'Divdrisht Suri',
        ...
        {
            url: 'instructors/Praful Jain (@praful_creations).jpg',
            name: 'Praful Jain',
        ...
        {
            url: 'instructors/Nikhat Sheikh (@nikhatillustrations).jpg',
            name: 'Nikhat Sheikh',
        ...
        {
            url: 'instructors/Paridhi Jhanwar (@pari.doodles).jpg',
        ...
        {
            url: 'instructors/Saudamini Madra (@saudamini.madra).jpg',
