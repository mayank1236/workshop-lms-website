...
router.post("/admin/curValue", AdminController.currencyVal);
...
router.get(
  "/user/service-category/shop-services/:user_id/:id/:page",
  ServiceController.viewShopServicesPerService
); // added by anirbank-93

router.get(
  "/user/shop/top-services",
  ShopServiceController.viewTopServiceProvider
); // added by anirbank-93
...
router.get(
  "/user/shop/shopservice-details/:id",
  ShopServiceController.viewShopServiceDetails
); // added by anirbank-93
router.get(
  "/user/shop/shopservice-details-new/:id",
  ShopServiceController.viewShopServiceDet
);
